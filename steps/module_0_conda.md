# Anacondo Environment - Module 0
This is my Anaconda course. I hope you like it.
...
Your root directory should look like the following. It is the main folder you save your projects in. The is particularly important as we shall set the virtual environment utilizing the Anaconda System. As later updates from libraries are released, some may not work with others, anaconda however maintains a working set of releases that are set and tested. Therfore utilizing a virtual environment utilizing conda will facilitate any errors that we may face due to later release or compability issues with python libraries with each others or / and with the enterpreter. 
المجلد الجذري مهم للعمل على البرمجيات لان ملف البيئة الإفتراضية ينم حصره وتكوينه لكل مشروع على حدى، يوجد خدمة لتعيير الإصدارات المتجانسة لبايثون، حيث يوجد دوما مشكلات تحديثية لعدم تناغم تحديثات المكتبات معاًَ. وعليه يتم الإستعانة بخدمة أناكوندا والتي تتحقق من فرز الاصدارات المتناسقة من المكتبات وال إصدار معالج بايثون. 
```
RootFolder\  <--This is the root directory <--المجلد الجذري
    Projects\
        CurrentProject\
            ...
        >requirements.txt
